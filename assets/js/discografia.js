export const piper = `<h1 class="main_title">The Piper at Gates of Dawn</h1>
<div>
    <img src="./assets/img/1_the_piper.jpg" alt="The Piper at Gates of Dawn" class="discos">
</div>
<p>
    The Piper at the Gates of Dawn é o álbum de estreia da banda britânica de 
    rock Pink Floyd, lançado em agosto de 1967. Foi o único álbum da banda que 
    foi feito sob a liderança de Syd Barrett. O álbum tem letras caprichosas 
    sobre espantalhos, gnomos, bicicletas e contos de fadas, juntamente com 
    passagens instrumentais de rock psicodélico. É considerado um dos pioneiros 
    do art rock. O álbum foi gravado nos Abbey Road Studios, e foi distribuído 
    em 1967, chegando a ser o 6º mais vendido no Reino Unido e o 131º mais vendido 
    nos Estados Unidos. The Piper at the Gates of Dawn foi produzido no estúdio 
    Abbey Road, simultaneamente às gravações de outro grande sucesso da indústria 
    fonográfica britânica: o oitavo dos Beatles, Sgt. Pepper’s Lonely Hearts 
    Club Band. O convívio durante esse período acabou proporcionando grande troca 
    de influências musicais entre as duas bandas. Ambos os discos refletem a onda 
    de experimentação que marcou os processos de composição e gravação da época. 
    O álbum é o único registro da liderança do vocalista e compositor Syd Barrett, 
    autor da maior parte das faixas do disco. O consumo excessivo de drogas e o 
    mau comportamento fizeram com que os outros integrantes da banda convidassem 
    o cantor e guitarrista David Gilmour para substituir Barrett. O título do álbum 
    é baseado no conto infantil O vento nos salgueiros, de Kenneth Grahame, onde o 
    Rato e a Toupeira, enquanto procuram um animal perdido, têm uma experiência 
    religiosa. ("Este é o local do meu sonho, onde eu ouvi a música," segredou o 
...
export const saucerful = `<h1 class="main_title">A Saucerful of Secrets</h1>
<div>
    <img src="./assets/img/2_saucerful.jpg" alt="A Saucerful of Secrets" class="discos">
</div>
<p>
...
export const more = `<h1 class="main_title">More</h1>
<div>
    <img src="./assets/img/3_more.jpg" alt="More" class="discos">
</div>
<p>
...
export const ummagumma = `<h1 class="main_title">Ummagumma</h1>
<div>
    <img src="./assets/img/4_ummagumma.jpg" alt="Ummagumma" class="discos">
</div>
<p>
...
export const atom = `<h1 class="main_title">Atom Heart Mother</h1>
<div>
    <img src="./assets/img/5_atom.jpg" alt="Atom Heart Mother" class="discos">
</div>
<p>
Atom Heart Mother é o quinto álbum de estúdio da banda inglesa de rock Pink Floyd. Foi lançada pela Harvest e pela EMI Records a 2 de Outubro de 1970 no Reino Unido, e pela Harvest e Capitol a 10 de Outubro de 1970 nos Estados Unidos. Foi gravado nos estúdios de Abbey Road, em Londres, e foi o primeiro álbum da banda a chegar ao primeiro lugar nas tabelas de vendas do Reino Unido, enquanto que nos EUA apenas alcançou a 55ª posição, acabando, no entanto, por receber o disco de ouro da RIAA neste país.
 Em 1994, foi comercializado uma versão em CD no Reino Unido e EUA, e, de novo, em 2011. Ron Geesin, que já tinha trabalhado com Roger Waters, teve um papel destacado na elaboração do álbum, recebendo o raro direito de ver o seu nome creditado em uma das músicas.
...
export const meddle = `<h1 class="main_title">Meddle</h1>
<div>
    <img src="./assets/img/6_meddle.jpg" alt="Meddle" class="discos">
</div>
<p>
...
Meddle foi gravada entre vários concertos agendados da banda, e a sua produção estendeu-se por um longo período de tempo. O grupo gravou na primeira quinzena de Abril de 1971, sendo a segunda metade desse mês ocupada com concertos em Doncaster e Norwich antes de retomar as gravações. Em Maio, dividiram o tempo entre sessões em Abbey Road, e em ensaios e concertos em Londres, Lancaster, Stirling, Edimburgo, Glasgow e Nottingham. Os meses de Junho e Julho foram passados a tocar em vários locais da Europa. O mês de Agosto foi passado no Médio Oriente e Austrália, Setembro na Europa, e Outubro e Novembro nos Estados Unidos. No mesmo período, o grupo também produziu Relics, uma compilação dos primeiros trabalhos dos Pink Floyd. Uma versão quadrifónica do álbum foi preparada nos Command Studios em 21 e 26 de Setembro, mas permanece por comercializar.
</p>
<p class="youtube">
...
export const clouds = `<h1 class="main_title">Obscured by Clouds</h1>
<div>
    <img src="./assets/img/7_clouds.jpg" alt="Obscured by Clouds" class="discos">
</div>
<p>
...
export const moon = `<h1 class="main_title">The Dark Side of the Moon</h1>
<div>
    <img src="./assets/img/8_moon.png" alt="The Dark Side of the Moon" class="discos">
</div>
<p>
...
The Dark Side of the Moon foi um sucesso imediato, chegando ao topo da Billboard 200 nos Estados Unidos (esta parada musical lista os 200 álbuns mais vendidos a cada semana nos EUA). "The Dark Side of The Moon" permaneceu nesta parada durante 777 semanas - de 1973 a 1988 - sendo o álbum recordista de duração na Billboard 200. Após uma mudança na forma como a Billboard passou contabilizar as vendas em 2009, o álbum entrou novamente no gráfico da Billboard 200 e desde então figurou por lá por mais de 900 semanas.
...
export const animals = `<h1 class="main_title">Animals</h1>
<div>
    <img src="./assets/img/10_animals.jpg" alt="Animals" class="discos">
</div>
<p>
...
O álbum contém um estilo mais duro e teatral do que os lançamentos anteriores do Pink Floyd. O tecladista Richard Wright deixou a banda durante a produção do álbum, embora tenha continuado no processo de gravação como um músico pago, apresentando-se com o grupo na turnê The Wall. Comercialmente bem-sucedido desde o seu lançamento, o álbum foi um dos mais vendidos de 1980 e vendeu mais de 11,5 milhões de unidades nos Estados Unidos, atingindo a primeira posição da Billboard. Um dos singles lançados, "Another Brick in the Wall, Part 2", esteve em várias paradas ao redor do mundo. Em 2003, a revista Rolling Stone listou The Wall na 87.ª posição em sua lista dos 500 melhores álbuns de todos os tempos.
</p>
<p class="youtube">
...
export const cut = `<h1 class="main_title">The Final Cut</h1>
<div>
    <img src="./assets/img/12_cut.jpg" alt="The Final Cut" class="discos">
</div>
<p>
...
export const reason = `<h1 class="main_title">A Momentary Lapse of Reason</h1>
<div>
    <img src="./assets/img/13_reason.jpg" alt="A Momentary Lapse of Reason" class="discos">
</div>
<p>
...
export const bell = `<h1 class="main_title">The Division Bell</h1>
<div>
    <img src="./assets/img/14_bell.jpg" alt="The Division Bell" class="discos">
</div>
<p>
...
Dois dias após o lançamento do álbum, a The Division Bell Tour teve início no Sun Life Stadium, no subúrbio de Miami. A setlist começou com a canção "Astronomy Domine", de seu álbum de estreia, antes de passar para as faixas de A Momentary Lapse of Reason de 1987, e The Division Bell. Também foram incluídas músicas dos álbuns Wish You Were Here, Dark Side of the Moon e The Wall.
...
export const endless = `<h1 class="main_title">The Endless River</h1>
<div>
    <img src="./assets/img/15_endless.jpg" alt="The Endless River" class="discos">
</div>
<p>
